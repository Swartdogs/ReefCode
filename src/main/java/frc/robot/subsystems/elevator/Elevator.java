...
public class Elevator extends SubsystemBase
{
    ...
    public void periodic()
    {
        ...
        {
            _io.setVolts(MathUtil.clamp(_extensionPID.calculate(_inputs.extensionPosition, _extensionSetpoint) + Constants.Elevator.ELEVATOR_FEED_FORWARD, -Constants.General.MOTOR_VOLTAGE/2, Constants.General.MOTOR_VOLTAGE));
        }
