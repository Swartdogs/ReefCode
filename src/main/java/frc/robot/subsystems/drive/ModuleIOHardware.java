...
public class ModuleIOHardware implements ModuleIO
{
    ...
    public ModuleIOHardware(int module)
    {
        ...
        driveConfig.CurrentLimits.StatorCurrentLimit       = Constants.Drive.DRIVE_MOTOR_CURRENT_LIMIT;
    ...
    public void updateInputs(ModuleIOInputs inputs)
    {
        ...
        inputs.rawRotationPosition   = Rotation2d.fromRotations(_turnPot.get());
