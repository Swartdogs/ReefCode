...
public final class Constants
{
    ...
    public static class Drive
    {
        ...
        public static final RobotConfig     PP_CONFIG                   = new RobotConfig(
                ROBOT_MASS, ROBOT_MOI, new ModuleConfig(WHEEL_RADIUS, MAX_LINEAR_SPEED, WHEEL_COF, DRIVE_GEARBOX.withReduction(DRIVE_MOTOR_REDUCTION), DRIVE_MOTOR_CURRENT_LIMIT, 1), MODULE_TRANSLATIONS
        );
    }
}
